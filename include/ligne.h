...
/*
  Même fonctionalité que ecrireLigne mais non bloquant
*/
int sendLigne(int fd, char *buffer) ;

/*
  Même fonctionalité que lireLigne mais non bloquant
*/
int recvLigne(int fd, char *buffer) ;
#endif
